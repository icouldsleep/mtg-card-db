...
**STATUS: BUILT (100 cards), confirmed Sept 19, 2026.** Cut down from the 181-card Archidekt staging pool after a full database cross-check (existence, color identity, Commander legality, and full oracle text for every card) plus a synergy pass looking for interactions the category tags alone would've missed.
...
### Ramp (12)
Sol Ring, Llanowar Elves, Elvish Mystic, Sakura-Tribe Elder, Nature's Lore, Three Visits, Cultivate, Nissa Worldsoul Speaker, Exploration, Azusa Lost but Seeking, Loot Exuberant Explorer, Burgeoning
...
### Removal (6)
Beast Within, Kenrith's Transformation, Primal Might, Ulamog the Ceaseless Hunger, Warping Wail, Gift of the Gargantuan
...
## Game Changers
Only **Seedborn Muse** is confirmed on the official Game Changers list among cards in this deck. Vorinclex is NOT currently on the GC list.
